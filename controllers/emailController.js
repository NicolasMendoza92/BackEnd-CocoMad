...
exports.createEmail = async (req, res, next) => {
  ...
  const { buyerEmail, buyerName, pickUp, deliveryDate, deliveryHour, productsList, sendPrice, discount, totalPurchase } = req.body
  ...
  try {
    ...
    <div class="d-flex justify-content-start">
       ...
       <h3 style="color:red;"> Recuerda que para finalizar el pedido es necesario coordinar el pago por <a href="https://wa.me/c/34635790277" target="blank"> WhatsApp </a> </h3>
      <ul >
         ...
         <li> Pagas: ${totalPurchase.toFixed(2)} EUR </li>
      </ul>
